...
**Domain:** Rust event sourcing library (workspace of crates)
...
**For the core `event-sourcing` crate (no I/O):**
...
**For `event-sourcing-logstore-inmemory`:**
...
**For `event-sourcing-logstore-sqlite`:**
...
**If a proc-macro crate is added (optional `event-sourcing-macros`):**
...
---
*Stack research for: Rust event sourcing library workspace*
*Researched: 2026-04-04*
