...
- **Global scope**: `/Users/eythorsson/Documents/Git/event-sourcing/.claude/worktrees/phase-4/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/eythorsson/Documents/Git/event-sourcing/.claude/worktrees/phase-4/.claude/notes/`)
...
2. Glob `/Users/eythorsson/Documents/Git/event-sourcing/.claude/worktrees/phase-4/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/eythorsson/Documents/Git/event-sourcing/.claude/worktrees/phase-4/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/eythorsson/Documents/Git/event-sourcing/.claude/worktrees/phase-4/.claude/notes/` — works in any directory
